			...
			<section className='section row second'>
				<div className='division'>
					<p>
						...
						reiciendis optio odit dolores blanditiis esse amet veniam itaque excepturi
						dolorem quas recusandae, eligendi voluptas, ut tempore assumenda et tempora?
					</p>
				</div>
				<div className='division'>
					<p>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad non dolorum est
						obcaecati, vero vitae architecto exercitationem culpa ex laboriosam
						blanditiis distinctio inventore dicta totam minus, alias unde voluptates
						fuga.
					</p>
				</div>
			</section>
