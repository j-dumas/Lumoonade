	...
	return (
		<div className="column principal first section center">
			<div className="column sub-section">
				...
				<p>
					By accessing this Website, accessible from https://lumoonade.com/en, you are agreeing to be bound by
				...
				<p>
					This will let Lumoonade to terminate upon violations of any of these restrictions. Upon termination,
				...
				<p>
					Lumoonade or its suppliers will not be hold accountable for any damages that will arise with the use
					or inability to use the materials on Lumoonade’s Website, even if Lumoonade or an authorize
				...
				<p>
					The materials appearing on Lumoonade’s Website may include technical, typographical, or photographic
					errors. Lumoonade will not promise that any of the materials in this Website are accurate, complete,
					or current. Lumoonade may change the materials contained on its Website at any time without notice.
					Lumoonade does not make any commitment to update the materials.
				</p>

				<h2>6. Links</h2>

				<p>
					Lumoonade has not reviewed all of the sites linked to its Website and is not responsible for the
					contents of any such linked site. The presence of any link does not imply endorsement by Lumoonade
				...
				<p>
					Lumoonade may revise these Terms of Use for its Website at any time without prior notice. By using
