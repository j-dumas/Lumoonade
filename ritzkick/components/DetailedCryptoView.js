                ...
                <div className='column'>
                    ...
                    <div className='column detailed-crypto-div'>
                        ...
                        <div className='row detailed-crypto-div'>
                            <ButtonLegend sendData={getShowPrice} value={showPrice} name="Price" backgroundColor="orange"/>
                            <ButtonLegend sendData={getShowChange} value={showChange} name="24h change" backgroundColor="blue"/>
