            ...
            <Modal>
                <div className='edit-popup'>
                    <form id='update-form' onSubmit={(event) => {handleSubmit(event, props.username, isOpen)}}>
                        ...
                        <input id="passwordField" type="password" placeholder='Nouveau mot de passe' onChange={handleNewPasswordChange} minLength="8"></input>
                        <input id="passwordConfirmationField" type="password" placeholder='Confirmation nouveau mot de passe' onChange={handleNewConfirmationPasswordChange} minLength="8"></input>
