...
function Bubbles() {
    return (
        <div>
                <img className='bubble x1' src="https://cryptologos.cc/logos/ethereum-eth-logo.svg?v=018" alt='/cloud.png' /> 
                ...
                <img className='bubble x7' src="https://cryptologos.cc/logos/dogecoin-doge-logo.svg?v=018" /> 
                <img className='bubble x8' src="https://cryptologos.cc/logos/bitcoin-btc-logo.svg?v=018" />
                <img className='bubble x9' src="https://cryptologos.cc/logos/dogecoin-doge-logo.svg?v=018" /> 
                <img className='bubble x10' src="https://cryptologos.cc/logos/shiba-inu-shib-logo.svg?v=018" />
        </div>
    );
}
